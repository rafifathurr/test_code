                                ...
                                <form id="form_add" action="{{ route('admin.category.' . $url) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="form-control" name="note" id="note" rows="2" cols="10"  autocomplete="off" {{ $disabled_ }} style="width:100%">@if (isset($categories)) {{ $categories->note }} @endisset</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="modal-footer">
                                        <div style="float:right;">
                                            @if ($title == 'Add Category Product' || $title == 'Edit Category Product')
